...
//void pk2xi(int N,  double k[], double pk[], double r[], double xi[]);

/* Compute the power spectrum P(k) from a correlation function xi(r), sampled
 * at logarithmically spaced points r[i]. */
///void xi2pk(int N, double r[], double xi[], double k[], double pk[]);
...
void fht(int N, double r[], double complex a[], double k[], double complex b[], double mu,
