...
#Path to mask1 (none if no mask): files_for_test/window_nseries/Window_cmass_ngc_Nseries_Om0.286_window_10p.txt
...
#Maximum number of mcmic accepted steps: 1000000
...
#RSD-fit (yes/no/shape/shape2): shape2
#sigma8 free parameter (yes/no): no
#FoG free parameter (yes/no): yes
#Same FoG parameter for bispectrum (yes/no): no

#Read out parameters
#Path to output: ./files_for_test/output_nseries
#Identifier of output: test_nseries
